...
/**
 * Converts value (brightness), saturation and hue to red, green and blue component.
 */
void led_strip_hsv2rgb(uint8_t v, uint8_t s, uint16_t h, uint8_t *r, uint8_t *g, uint8_t *b);
